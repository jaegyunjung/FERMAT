#!/usr/bin/env python3
"""Build the Task 30 diabetes-to-CKD CPU follow-up Pod bundle."""
...
def main():
    ...
    bundle_id = f"snuh_task30_diabetes_ckd_cpu_followup_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "analysis": "Adjusted diabetes-record recency and pre-index renal-abnormality sensitivity audit",
        "uses_gpu": False,
        "imports_torch": False,
        "runs_rollout": False,
    }
