#!/usr/bin/env python3
"""Build a versioned Pod bundle for Task 27 primary direct-risk dry runs."""
...
def main():
    ...
    bundle_id = f"snuh_task27_primary_direct_risk_{state}_{content_hash}"
    output = ROOT / "dist" / "task27_primary_direct_risk" / f"{bundle_id}.zip"
    ...
    manifest = {
        ...
        "files": FILES,
        "pod_task_dir": "/home/khdp-user/workspace/fermat-data/task27",
        "pod_extract_command": (
            "TASK_DIR=/home/khdp-user/workspace/fermat-data/task27\n"
