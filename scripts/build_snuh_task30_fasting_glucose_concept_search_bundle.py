#!/usr/bin/env python3
"""Build a Pod bundle for fasting-glucose OMOP concept metadata search."""
...
FILES = ["scripts/audit_snuh_task30_fasting_glucose_concepts.py"]
...
def main():
    ...
    bundle_id = f"snuh_task30_fasting_glucose_concept_search_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "tables_read": ["concept", "concept_relationship"],
    }
