#!/usr/bin/env python3
"""Build the Task30 diabetes rollout-risk stratification Pod bundle."""
...
FILES = [
    ...
    "scripts/run_snuh_task30_group_mortality_risk_curves.py",
    "scripts/run_snuh_task30_diabetes_rollout_stratification.py",
]
...
def main():
    ...
    bundle_id = f"snuh_task30_diabetes_rollout_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "analysis": (
            "observed vs Clinical Cox vs FERMAT+Clinical Cox vs FERMAT rollout "
            "diabetes curves and rollout-risk strata"
        ),
    }
