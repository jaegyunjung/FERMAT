#!/usr/bin/env python3
"""Build the Pod zip for the Task 30 ACEi-vs-CCB feasibility audit."""
...
FILES = ["scripts/audit_snuh_task30_acei_ccb_mace_feasibility.py"]
...
def main():
    ...
    bundle_id = f"snuh_task30_acei_ccb_audit_{git_state()}_{content_hash}"
