#!/usr/bin/env python3
"""Build a Pod bundle for the CKD statin feasibility audit."""
...
FILES = [
    "scripts/audit_snuh_task30_ckd_statin_feasibility.py",
...
def main():
    ...
    bundle_id = f"snuh_task30_ckd_statin_feasibility_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "analysis_type": "aggregate_feasibility_only",
    }
