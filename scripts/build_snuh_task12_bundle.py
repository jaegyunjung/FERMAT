"""Build a versioned SNUH Task 12 scaling-sweep bundle."""
...
def main():
    ...
    bundle_id = f"snuh_task12_scaling_{short_commit}_{state}_{digest[:12]}"
    ...
    manifest = {
        ...
        "git_dirty": dirty,
        "files": FILES,
        "entrypoint": "python scripts/run_snuh_scaling_sweep.py",
    }
