#!/usr/bin/env python3
"""Build the Task 30 group all-cause mortality risk-curve Pod bundle."""
...
def main():
    ...
    bundle_id = f"snuh_task30_group_mortality_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "analysis": "observed vs clinical-Cox vs FERMAT-embedding-Cox group all-cause mortality curves",
    }
