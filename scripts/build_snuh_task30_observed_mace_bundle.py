#!/usr/bin/env python3
"""Build the Task 30 observed cardiovascular-event curve Pod bundle."""
...
FILES = ["scripts/run_snuh_task30_observed_mace_feasibility.py"]
...
def main():
    ...
    bundle_id = f"snuh_task30_observed_mace_feasibility_{git_state()}_{content_hash}"
