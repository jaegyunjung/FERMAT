#!/usr/bin/env python3
"""Build the Task 30 diabetes-to-CKD editability Pod bundle."""
...
FILES = [
    ...
    "config/snuh_task30_diabetes_ckd_editability.json",
]
...
def main():
    ...
    bundle_id = f"snuh_task30_diabetes_ckd_editability_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "analysis": "Same-patient diabetes history editability before CKD rollout",
        "uses_gpu": False,
        "imports_torch": False,
