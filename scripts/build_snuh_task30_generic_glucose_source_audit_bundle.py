#!/usr/bin/env python3
"""Build the Pod bundle for generic-glucose source-code inspection."""
...
FILES = ["scripts/audit_snuh_task30_generic_glucose_source_codes.py"]
...
def main():
    ...
    bundle_id = f"snuh_task30_generic_glucose_source_audit_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "analysis_type": "aggregate_source_code_audit",
        "standard_glucose_concept_id": 3004501,
    }
