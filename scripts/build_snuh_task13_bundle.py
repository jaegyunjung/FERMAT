"""Build a versioned SNUH Task 13 waiting-time (loss_dt) diagnostic bundle."""
...
def main():
    ...
    bundle_id = f"snuh_task13_dt_{short_commit}_{state}_{digest[:12]}"
    ...
    manifest = {
        ...
        "git_dirty": dirty,
        "files": FILES,
        "entrypoint": "python scripts/run_snuh_task13_dt.py",
    }
