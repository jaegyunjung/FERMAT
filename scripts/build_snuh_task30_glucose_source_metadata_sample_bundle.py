#!/usr/bin/env python3
"""Build the bounded glucose source-code metadata/sample audit bundle."""
...
FILES = ["scripts/audit_snuh_task30_glucose_source_metadata_sample.py"]
...
def main():
    ...
    bundle_id = f"snuh_task30_glucose_source_metadata_sample_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "analysis_type": "vocabulary_metadata_plus_bounded_measurement_sample",
