#!/usr/bin/env python3
"""Build the Pod bundle for the JAMA 2026 ADM-timing feasibility audit."""
...
FILES = ["scripts/audit_snuh_task30_adm_timing_feasibility.py"]
...
def main():
    ...
    bundle_id = f"snuh_task30_adm_timing_feasibility_{git_state()}_{content_hash}"
    ...
    manifest = {
        ...
        "analysis_type": "train_val_aggregate_feasibility_only",
        "paper": "Ko et al. JAMA Network Open 2026 e2619362",
